...
expression:
    L_BR value comma value expression_list R_BR { debug_print("expression\n"); }
    ;

expression_list:
    comma value { debug_print("expression list\n"); }
    | expression_list comma value { debug_print("expression list\n"); }
    ;
