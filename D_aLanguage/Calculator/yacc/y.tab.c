...
static const YYINT yystos[] = {                           0,
  257,  258,  265,  267,  269,  270,  271,  272,  261,  261,
  272,  264,  259,  260,  264,  265,  268,  268,  270,  270,
  263,  262,  262,  265,  263,  265,
};
...
static const YYINT yysindex[] = {                      -257,
 -254, -251,    0, -257, -258,    0, -255,    0, -253, -253,
    0,    0, -252, -252,    0, -249, -247, -246,    0,    0,
 -248,    0,    0, -245, -244,    0,
};
...
static const YYINT yytable[] = {                          1,
    2,   19,   20,   13,   14,   12,    9,    3,   15,   10,
    1,   16,    3,   21,   22,   23,   24,   25,   14,   18,
   26,   11,
};
static const YYINT yycheck[] = {                        257,
  258,   13,   14,  259,  260,  264,  261,  265,  264,  261,
    0,  265,  265,  263,  262,  262,  265,  263,  262,   10,
  265,    4,
};
#if YYBTYACC
...
"R_BR","COMM","LINE_END","NUMBER","$accept","Lang","expr","action","value",
"basic","expression","illegal-symbol",
};
...
"Lang : expression",
"expression : basic LINE_END",
"expression : action LINE_END",
"basic : value",
"basic : basic PLUS value",
"basic : basic MPY value",
"value : NUMBER",
"action : N_S_D L_BR expr R_BR",
"action : S_D L_BR expr R_BR",
"expr : NUMBER COMM NUMBER COMM NUMBER",
"expr : NUMBER COMM NUMBER COMM NUMBER",
"expr : NUMBER COMM NUMBER",
"expr : NUMBER COMM NUMBER",
